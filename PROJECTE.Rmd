...
df$f.bed <- cut(df$bedrooms, quantile(df$bedrooms, prob = seq(0,1,0.5)), include.lowest = TRUE)
table(df$f.bed)
...
df$f.antig <- cut(df$antiguetat, quantile(df$antiguetat, prob = seq(0,1,0.2)), include.lowest = TRUE)
table(df$f.antig)
summary(df$f.antig)
